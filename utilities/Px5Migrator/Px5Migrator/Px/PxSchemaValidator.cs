...
namespace Px5Migrator
{
    ...
    public class KeywordValidator : AbstractValidator<IPxKeywordElement>
    {
        ...
        {
            string configLanguage = "en";
            string errorMessageLenMinMax = "Wrong Key length";
            string errorMessageLenMin = "Key length too small";
            string errorMessageBoolean = "Boolean error";
            string errorMessageNumericMinMax = "Number wrong size";
            string errorMessageAlphaNumeric = "Alphanumeric error";
        ...
        private IRuleBuilderOptions<PxDocument, IList<IPxKeywordElement>> OneOfPxElementMustExist(string v1, string v2)
        {
            ...
            return
                        RuleFor(doc => doc.Keywords)
                            ...
                            .WithMessage("One of each px element must exist");
        }
