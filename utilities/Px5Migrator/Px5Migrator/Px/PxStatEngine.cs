...
namespace Px5Migrator
{
    ...
    public class PxStatEngine : IPxStatEngine
    {
        ...
        /// <param name="pxInput"></param>
        /// <returns></returns>
        public virtual PxDocument ParsePxFile(string pxInput)
        {
            return PxParser.Parse(pxInput);
        }
        ...
        /// <param name="pxInput"></param>
        /// <returns></returns>
        internal static PxDocument CreatePxDocument(string pxInput)
        {
            PxDocument result = null;
            ...
            {
                Log.Instance.ErrorFormat("Error Parsing px string");
                Log.Instance.Error(e);
            }
