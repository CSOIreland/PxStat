...
namespace Px5Migrator
{
    ...
    public class Dspec_VLD : AbstractValidator<IDspec>
    {
        ...
        {
            return spec.Dimensions.Where(x => x.Role == "TIME").Count() == 1;
        }
        ...
        {
            return spec.Dimensions.Where(x => x.Role == "STATISTIC").Count() == 1;
        }
        ...
        {
            int scount = spec.Dimensions.Where(x => x.Role == "CLASSIFICATION").Count();
