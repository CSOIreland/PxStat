...
/*
 exec App_Settings_Migrate_Update 'config.global.json','{
  ...
  "url": {
    "api": {
      "restful": "https://domain.ext/public/api.restful",
      "static": "https://domain.ext/public/api.static"
    },
    "logo": "https://domain.ext/image/logo.png",
    "application": "https://domain.ext/"
...
ALTER PROCEDURE [dbo].[App_Settings_Migrate_Update] @appkey VARCHAR(200)
