...
{
    internal class Login_BSO_InitiateUpdate2FA : BaseTemplate_Update<Login_DTO_InitiateUpdate2FA, Login_VLD_InitiateUpdate2FA>
    {
        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="request"></param>
        internal Login_BSO_InitiateUpdate2FA(JSONRPC_API request) : base(request, new Login_VLD_InitiateUpdate2FA())
        {
        }
