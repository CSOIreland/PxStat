...
namespace PxStat.Data
{
    ...
    internal class Cube_BSO_ReadPreDataset : BaseTemplate_Read<CubeQuery_DTO, JsonStatPreQuery_VLD>
    {
        ...
        protected override bool Execute()
        {
            ...
            MemCachedD_Value cache = AppServicesHelper.CacheD.Get_BSO<dynamic>("PxStat.Data", "Cube_API", "ReadPreDataset", DTO);
            ...
            var hasRun = Cube_BSO_ReadDataset.ExecuteReadDatasetDmatrix(Ado,  DTO, release, Response, DTO.jStatQueryExtension.extension.Language.Code, DTO.jStatQueryExtension.extension.Language.Culture, false, false);



           AppServicesHelper.CacheD.Store_BSO<dynamic>("PxStat.Data", "Cube_API", "ReadPreDataset", DTO, Response.data, new DateTime(), Resources.Constants.C_CAS_DATA_CUBE_READ_PRE_DATASET + DTO.jStatQueryExtension.extension.RlsCode);
