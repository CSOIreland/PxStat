...
namespace PxStat.Data.Px
{
    ...
    public class KeywordValidator : AbstractValidator<IPxKeywordElement>
    {
        ...
        private void SetRuleBoolean(string identifierName, string errorMessage)
        {
            RuleFor(x => x.Element.ToPxValue().ToUpper())
                .Must(x => x == Configuration_BSO.GetStaticConfig("APP_PX_TRUE") || x == Configuration_BSO.GetStaticConfig("APP_PX_FALSE"))
                .When(x => x.Key.Identifier == identifierName)
        ...
        {
            string configLanguage = RequestLanguage.LngIsoCode == null ? Configuration_BSO.GetApplicationConfigItem(ConfigType.global, "language.iso.code") : RequestLanguage.LngIsoCode;
            ...
            string regularExpressionAphaNumeric = Configuration_BSO.GetApplicationConfigItem(ConfigType.global, "regex.matrix-name"); //Do not use translate
    ...
    /// class
    /// </summary>
    public class PxSchemaValidator : AbstractValidator<PxDocument>
    {
        /// <summary>
        /// class variable 
        /// </summary>
        ...
        internal PxSchemaValidator(IADO ado) : this()
        {
            this.ado = ado;
        }
