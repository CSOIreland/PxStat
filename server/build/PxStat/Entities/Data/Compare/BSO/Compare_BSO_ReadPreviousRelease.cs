...
namespace PxStat.Data
{
    ...
    internal class Compare_BSO_ReadPreviousRelease : BaseTemplate_Read<Compare_DTO_ReadPrevious, Compare_VLD_ReadPrevious>
    {
        ...
        protected override bool Execute()
        {
            ...
            var currentRelease = Release_ADO.GetReleaseDTO(new Matrix_ADO(Ado).Read(DTO.RlsCode, Configuration_BSO.GetApplicationConfigItem(ConfigType.global, "language.iso.code"), SamAccountName));
