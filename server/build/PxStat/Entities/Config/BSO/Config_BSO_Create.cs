...
namespace PxStat.Config
{
    ...
    /// 
    /// </summary>
    internal class Config_BSO_Create : BaseTemplate_Create<Config_DTO_Create, Config_VLD_Create>
    {
        ...
        internal Config_BSO_Create(JSONRPC_API request) : base(request, new Config_VLD_Create())
        {
        }
