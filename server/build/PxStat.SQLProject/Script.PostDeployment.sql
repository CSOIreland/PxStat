...
IF (SELECT COUNT(*) FROM TS_CONFIG_SETTING_TYPE WHERE CST_CODE='API')=0
BEGIN
	INSERT INTO TS_CONFIG_SETTING_TYPE (CST_CODE,CST_VALUE)
	VALUES('API','API CONFIG')
END

IF(SELECT COUNT(*) FROM TS_CONFIG_SETTING_TYPE WHERE CST_CODE='APP')=0
BEGIN
	INSERT INTO TS_CONFIG_SETTING_TYPE (CST_CODE,CST_VALUE)
	VALUES('APP','APP CONFIG')
END

IF (SELECT COUNT(*) FROM TM_APP_SETTING_CONFIG_VERSION WHERE ASV_CST_ID=1)=0
BEGIN
	INSERT INTO TM_APP_SETTING_CONFIG_VERSION (ASV_VERSION,ASV_CST_ID)
	VALUES(1.00,1)
END

IF (SELECT COUNT(*) FROM TM_APP_SETTING_CONFIG_VERSION WHERE ASV_CST_ID=2)=0
BEGIN
	INSERT INTO TM_APP_SETTING_CONFIG_VERSION (ASV_VERSION,ASV_CST_ID)
	VALUES(1.00,2)
END
