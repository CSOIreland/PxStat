...
namespace PxStat.Security
{
    ...
    /// </summary>
    internal class Performance_BSO_ReadPrfMemoryAvailable : BaseTemplate_Read<Performance_DTO_Read, Performance_VLD_Read>
    {
        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="request"></param>
        internal Performance_BSO_ReadPrfMemoryAvailable(JSONRPC_API request) : base(request, new Performance_VLD_Read())
        { }
        ...
        protected override bool Execute()
        {
            ...
            else
            {
                ...
                foreach (dynamic element in myData)
                {
                    ...
                    // Retrieve data from the PrfMemory column
                    tempResults.DataValue = element.PrfMemory;
