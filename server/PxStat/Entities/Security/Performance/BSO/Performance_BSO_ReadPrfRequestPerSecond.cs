...
namespace PxStat.Security
{
    ...
    /// </summary>
    internal class Performance_BSO_ReadPrfRequestPerSecond : BaseTemplate_Read<Performance_DTO_Read, Performance_VLD_Read>
    {
        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="request"></param>
        internal Performance_BSO_ReadPrfRequestPerSecond(JSONRPC_API request) : base(request, new Performance_VLD_Read())
        { }
        ...
        protected override bool Execute()
        {
            ...
            else
            {
                ...
                foreach (dynamic element in myData)
                {
                    ...
                    // Retrieve data from the PrfRequestspersecond column
                    tempResults.DataValue = element.PrfRequestspersecond;
