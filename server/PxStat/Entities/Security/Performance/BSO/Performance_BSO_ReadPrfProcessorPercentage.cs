...
namespace PxStat.Security
{
    ...
    /// </summary>
    internal class Performance_BSO_ReadPrfProcessorPercentage : BaseTemplate_Read<Performance_DTO_Read, Performance_VLD_Read>
    {
        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="request"></param>
        internal Performance_BSO_ReadPrfProcessorPercentage(JSONRPC_API request) : base(request, new Performance_VLD_Read())
        { }
