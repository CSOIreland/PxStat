...
{
    internal class Build_BSO_BuildRead : BaseTemplate_Read<BuildUpdate_DTO, Build_VLD_BuildRead>
    {
        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="request"></param>
        internal Build_BSO_BuildRead(JSONRPC_API request) : base(request, new Build_VLD_BuildRead())
        { }
